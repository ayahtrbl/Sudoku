...
Sub InitGrid
	...
	For i = 0 To 80
		...
		cells(i).Text = Difficulty.EasySudoku
		cells(i).Gravity = Gravity.CENTER_HORIZONTAL
...
End Sub
	...
	If ans3.Text = 7 Then ans3.TextColor = Colors.Blue Else ans3.TextColor = Colors.Red
	If ans4.Text = 6 Then ans4.TextColor = Colors.Blue Else ans4.TextColor = Colors.Red
	If ans5.Text = 4 Then ans5.TextColor = Colors.Blue Else ans5.TextColor = Colors.Red
	If ans6.Text = 3 Then ans6.TextColor = Colors.Blue Else ans6.TextColor = Colors.Red
	If ans7.Text = 2 Then ans7.TextColor = Colors.Blue Else ans7.TextColor = Colors.Red
	If ans8.Text = 7 Then ans8.TextColor = Colors.Blue Else ans8.TextColor = Colors.Red
	If ans9.Text = 2 Then ans9.TextColor = Colors.Blue Else ans9.TextColor = Colors.Red
    If ans10.Text = 5 Then ans10.TextColor = Colors.Blue Else ans10.TextColor = Colors.Red
    If ans11.Text = 3 Then ans11.TextColor = Colors.Blue Else ans11.TextColor = Colors.Red
    If ans12.Text = 1 Then ans12.TextColor = Colors.Blue Else ans12.TextColor = Colors.Red
    If ans13.Text = 8 Then ans13.TextColor = Colors.Blue Else ans13.TextColor = Colors.Red
    If ans14.Text = 9 Then ans14.TextColor = Colors.Blue Else ans14.TextColor = Colors.Red
    If ans15.Text = 7 Then ans15.TextColor = Colors.Blue Else ans15.TextColor = Colors.Red
	If ans16.Text = 1 Then ans16.TextColor = Colors.Blue Else ans16.TextColor = Colors.Red
	If ans17.Text = 1 Then ans17.TextColor = Colors.Blue Else ans17.TextColor = Colors.Red
	If ans18.Text = 3 Then ans18.TextColor = Colors.Blue Else ans18.TextColor = Colors.Red
	If ans19.Text = 9 Then ans19.TextColor = Colors.Blue Else ans19.TextColor = Colors.Red
	If ans20.Text = 2 Then ans20.TextColor = Colors.Blue Else ans20.TextColor = Colors.Red
	...
	If ans24.Text = 5 Then ans24.TextColor = Colors.Blue Else ans24.TextColor = Colors.Red
	If ans25.Text = 4 Then ans25.TextColor = Colors.Blue Else ans25.TextColor = Colors.Red
	If ans26.Text = 9 Then ans26.TextColor = Colors.Blue Else ans26.TextColor = Colors.Red
	If ans27.Text = 8 Then ans27.TextColor = Colors.Blue Else ans27.TextColor = Colors.Red
	If ans28.Text = 3 Then ans28.TextColor = Colors.Blue Else ans28.TextColor = Colors.Red
	If ans29.Text = 1 Then ans29.TextColor = Colors.Blue Else ans29.TextColor = Colors.Red
	...
	If ans32.Text = 2 Then ans32.TextColor = Colors.Blue Else ans32.TextColor = Colors.Red
	If ans33.Text = 5 Then ans33.TextColor = Colors.Blue Else ans33.TextColor = Colors.Red
	If ans34.Text = 7 Then ans34.TextColor = Colors.Blue Else ans34.TextColor = Colors.Red
	If ans35.Text = 3 Then ans35.TextColor = Colors.Blue Else ans35.TextColor = Colors.Red
	If ans36.Text = 1 Then ans36.TextColor = Colors.Blue Else ans36.TextColor = Colors.Red
	If ans37.Text = 4 Then ans37.TextColor = Colors.Blue Else ans37.TextColor = Colors.Red 
	If ans38.Text = 8 Then ans38.TextColor = Colors.Blue Else ans38.TextColor = Colors.Red
