...
Sub InitGrid
	...
	For i = 0 To 80
		...
		cells(i).TextColor = Colors.White
		cells(i).TextSize = 16
...
Private Sub btnSolver_Click
	If ans1.Text = 1 Then ans1.TextColor = Colors.Blue Else ans1.TextColor = Colors.Red
	If ans2.Text = 5 Then ans2.TextColor = Colors.Blue Else ans2.TextColor = Colors.Red
	If ans3.Text = 8 Then ans3.TextColor = Colors.Blue Else ans3.TextColor = Colors.Red
	If ans4.Text = 8 Then ans4.TextColor = Colors.Blue Else ans4.TextColor = Colors.Red
	If ans5.Text = 6 Then ans5.TextColor = Colors.Blue Else ans5.TextColor = Colors.Red
	If ans6.Text = 4 Then ans6.TextColor = Colors.Blue Else ans6.TextColor = Colors.Red
	If ans7.Text = 1 Then ans7.TextColor = Colors.Blue Else ans7.TextColor = Colors.Red
	If ans8.Text = 3 Then ans8.TextColor = Colors.Blue Else ans8.TextColor = Colors.Red
	If ans9.Text = 5 Then ans9.TextColor = Colors.Blue Else ans9.TextColor = Colors.Red
	If ans10.Text = 4 Then ans10.TextColor = Colors.Blue Else ans10.TextColor = Colors.Red
	...
	If ans13.Text = 2 Then ans13.TextColor = Colors.Blue Else ans13.TextColor = Colors.Red
	If ans14.Text = 9 Then ans14.TextColor = Colors.Blue Else ans14.TextColor = Colors.Red
	If ans15.Text = 1 Then ans15.TextColor = Colors.Blue Else ans15.TextColor = Colors.Red
	If ans16.Text = 3 Then ans16.TextColor = Colors.Blue Else ans16.TextColor = Colors.Red
	If ans17.Text = 9 Then ans17.TextColor = Colors.Blue Else ans17.TextColor = Colors.Red
	...
	If ans20.Text = 4 Then ans20.TextColor = Colors.Blue Else ans20.TextColor = Colors.Red
	If ans21.Text = 8 Then ans21.TextColor = Colors.Blue Else ans21.TextColor = Colors.Red
	If ans22.Text = 7 Then ans22.TextColor = Colors.Blue Else ans22.TextColor = Colors.Red
	If ans23.Text = 5 Then ans23.TextColor = Colors.Blue Else ans23.TextColor = Colors.Red
	If ans24.Text = 3 Then ans24.TextColor = Colors.Blue Else ans24.TextColor = Colors.Red
	If ans25.Text = 1 Then ans25.TextColor = Colors.Blue Else ans25.TextColor = Colors.Red
	If ans26.Text = 2 Then ans26.TextColor = Colors.Blue Else ans26.TextColor = Colors.Red
	If ans27.Text = 2 Then ans27.TextColor = Colors.Blue Else ans27.TextColor = Colors.Red
	If ans28.Text = 1 Then ans28.TextColor = Colors.Blue Else ans28.TextColor = Colors.Red
	If ans29.Text = 5 Then ans29.TextColor = Colors.Blue Else ans29.TextColor = Colors.Red
	If ans30.Text = 3 Then ans30.TextColor = Colors.Blue Else ans30.TextColor = Colors.Red
	If ans31.Text = 9 Then ans31.TextColor = Colors.Blue Else ans31.TextColor = Colors.Red
	If ans32.Text = 8 Then ans32.TextColor = Colors.Blue Else ans32.TextColor = Colors.Red
	If ans33.Text = 3 Then ans33.TextColor = Colors.Blue Else ans33.TextColor = Colors.Red
	If ans34.Text = 6 Then ans34.TextColor = Colors.Blue Else ans34.TextColor = Colors.Red
	If ans35.Text = 1 Then ans35.TextColor = Colors.Blue Else ans35.TextColor = Colors.Red
	If ans36.Text = 3 Then ans36.TextColor = Colors.Blue Else ans36.TextColor = Colors.Red
	If ans37.Text = 2 Then ans37.TextColor = Colors.Blue Else ans37.TextColor = Colors.Red
	If ans38.Text = 5 Then ans38.TextColor = Colors.Blue Else ans38.TextColor = Colors.Red
	If ans39.Text = 7 Then ans39.TextColor = Colors.Blue Else ans39.TextColor = Colors.Red
	If ans40.Text = 1 Then ans40.TextColor = Colors.Blue Else ans40.TextColor = Colors.Red
End Sub
